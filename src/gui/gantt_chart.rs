...
impl Gui {
    pub(super) fn draw_gantt_chart_table(&mut self, _ui: &Ui, id: &str) -> bool {
    ...
    pub(super) fn draw_gantt_chart_calendar_row(&mut self, ui: &Ui) {
    ...
    pub(super) fn draw_gantt_chart_milestones_row(&mut self, ui: &Ui) {
        ui.table_next_row();
